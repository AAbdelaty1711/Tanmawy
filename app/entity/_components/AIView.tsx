...
export function AIView() {
  return (
    <div className="space-y-6">
      <div className="bg-indigo-50/50 border border-indigo-100 rounded-2xl p-6 flex flex-col md:flex-row items-center gap-6">
        <div className="relative w-24 h-24 shrink-0 flex items-center justify-center">
          ...
          <div className="absolute flex flex-col items-center justify-center">
            <span className="text-xl font-black text-indigo-900">80%</span>
          </div>
        </div>
        <div>
          <h3 className="text-lg font-black text-slate-900 mb-2">مؤشر النمو المدعوم بالذكاء الاصطناعي</h3>
